      ...
      <div className="max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-400">
          <button 
            ...
            className="hover:text-indigo-400 transition-colors duration-200 cursor-pointer font-medium"
          >
            Marketplace
          </button>
          <a href="#how-it-works" className="hover:text-indigo-400 transition-colors duration-200">How it works</a>
          <a href="#why-prope" className="hover:text-indigo-400 transition-colors duration-200">Why Prope</a>
